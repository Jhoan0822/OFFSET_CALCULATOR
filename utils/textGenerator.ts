...
import { PAPER_SIZES, PAPER_TYPES, FINISHES_CONFIG } from '../constants';
...
export const generateQuoteTextData = (quote: QuoteDetails, formState: FormState) => {
    ...
    return {
        ...
        paper: `Papel: ${paperTypeInfo.name} ${formState.paperWeight}gr (${selectedPaper.name} - ${selectedPaper.width}x${selectedPaper.height}cm)`,
        ...
        plateCost: `Costo de Placas: ${formatCurrency(quote.plateCost)}`,
